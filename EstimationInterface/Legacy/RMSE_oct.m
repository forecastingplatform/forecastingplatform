...
xlswrite('Report_oct',RMSE,['RMSE_h_' num2str(5)])
% xlswrite('Report_oct',REC_RMSE,['Recession RMSE h_' num2str(5)])
% xlswrite('Report_oct',NONREC_RMSE,['Non Recession RMSE h_' num2str(5)])
xlswrite('Report_oct',Report,['Report RMSE_h_' num2str(5)])
