function [residual, g1, g2, g3] = dssw_ff_static(y, x, params)
%
...
residual(45)= lhs-rhs;
lhs =y(46);
rhs =y(30)*100+params(35);
residual(46)= lhs-rhs;
lhs =y(47);
rhs =params(35)+100*(y(30)+log(y(3)));
residual(47)= lhs-rhs;
lhs =y(48);
rhs =400*(y(19)-y(2));
residual(48)= lhs-rhs;
...
T491 = (y(1)*beta__/T25-beta__*y(1)/T25)/(y(1)*y(1));
T531 = getPowerDeriv(T25*y(3),params(11),1);
T537 = (T76-y(3)*T25*T531)/(T76*T76)/T83;
T538 = getPowerDeriv(T84,T66,1);
T544 = getPowerDeriv(T84,T97,1);
T556 = getPowerDeriv(T83*T76*T107,T110,1);
T559 = getPowerDeriv(T116,(-params(2)),1);
T567 = getPowerDeriv(y(3),params(6),1);
T572 = (T264-y(3)*T567)/(T264*T264)/T267;
T596 = getPowerDeriv(T304,1-params(15),1);
...
T946 = (-(y(3)*T25*y(3)*T531))/(T76*T76)/T83;
T1064 = (exp(y(34))*(-exp(y(34)))-exp(y(34))*(-(1+exp(y(34)))))/(exp(y(34))*exp(y(34)));
T1102 = (exp(y(37))*0.5*exp(y(37))*2*exp(y(37))-exp(y(37))*T363)/(exp(y(37))*exp(y(37)));
  g1(1,1)=y(2)*T491/y(3);
  g1(1,2)=T27/y(3);
  ...
  g1(4,3)=(-(y(7)*exp(y(30)*T66)*beta__*params(10)*T537*T538));
  g1(4,6)=(-(T70*exp(y(32))*getPowerDeriv(y(6),T66,1)));
  g1(4,7)=1-T89;
  g1(4,9)=(-(T68*getPowerDeriv(y(9),1+params(9),1)));
  g1(4,30)=(-(y(7)*(exp(y(30)*T66)*beta__*params(10)*T538*T946+T86*T66*exp(y(30)*T66))));
  g1(4,32)=(-(T68*T70));
  g1(5,1)=(-(y(9)*T94));
  g1(5,3)=(-(y(8)*T101*beta__*params(10)*T537*T544));
  g1(5,6)=(-(y(9)*y(1)*getPowerDeriv(y(6),(1+params(2))/params(2),1)));
  g1(5,8)=1-T102;
  g1(5,9)=(-(y(1)*T94));
  g1(5,30)=(-(y(8)*(T101*beta__*params(10)*T544*T946+T99*T97*T101)));
  g1(6,3)=(-(params(10)*T83*(T107*T25*T531+T76*(-(y(6)/T25))/(y(3)*y(3)))*T556*T559));
  g1(6,5)=(-(T559*(1-params(10))*getPowerDeriv(y(5),T110,1)));
  g1(6,6)=1-T559*params(10)*T556*T83*T76*1/T25/y(3);
  g1(6,30)=(-(T559*params(10)*T556*T83*(T107*T25*y(3)*T531+T76*(-(T25*y(6)))/(T25*T25)/y(3))));
  ...
  g1(8,1)=(-(y(13)*T132*params(7)*T147*exp(y(33))*T491));
  ...
  g1(19,1)=(-(y(24)*y(28)));
  g1(19,3)=(-(y(26)*beta__*params(5)*T572*getPowerDeriv(T268,(1+exp(y(34)))/exp(y(34)),1)));
  g1(19,24)=(-(y(1)*y(28)));
  g1(19,26)=1-T271;
  g1(19,28)=(-(y(1)*y(24)));
  g1(19,34)=(-(y(26)*beta__*params(5)*T270*(exp(y(34))*exp(y(34))-exp(y(34))*(1+exp(y(34))))/(exp(y(34))*exp(y(34)))*log(T268)));
  g1(20,1)=(-y(28));
  g1(20,3)=(-(y(27)*beta__*params(5)*T572*getPowerDeriv(T268,1/exp(y(34)),1)));
  g1(20,27)=1-T278;
  g1(20,28)=(-y(1));
  g1(20,34)=(-(y(27)*beta__*params(5)*T277*log(T268)*(-exp(y(34)))/(exp(y(34))*exp(y(34)))));
  g1(21,3)=(-(params(5)*T267*(1/y(3)*T567+T264*(-1)/(y(3)*y(3)))*getPowerDeriv(T267*T264*1/y(3),T285,1)));
  g1(21,25)=(-((1-params(5))*getPowerDeriv(y(25),T285,1)));
  g1(21,34)=(-(params(5)*T286*exp(y(34))/(exp(y(34))*exp(y(34)))*log(T267*T264*1/y(3))+(1-params(5))*T289*exp(y(34))/(exp(y(34))*exp(y(34)))*log(y(25))));
  g1(22,2)=((y(2))-y(2))/((y(2))*(y(2)))-T311*T306*((y(2))-y(2))/((y(2))*(y(2)))*getPowerDeriv(y(2)/(y(2)),params(15),1);
  g1(22,3)=(-(T311*T296*T303*1/pic_star__*getPowerDeriv(y(3)/pic_star__,params(13),1)*T596));
  g1(22,28)=(-(T311*T296*T596*T299*((y(28))-y(28))/((y(28))*(y(28)))*getPowerDeriv(y(28)/(y(28)),params(14),1)));
  ...
  g1(26,3)=(-(y(29)*params(5)*(y(3)*T267*T567-T264*T267)/(y(3)*y(3))*getPowerDeriv(T264*T267/y(3),T347,1)));
  g1(26,25)=(-((1-params(5))*getPowerDeriv(y(25),T347,1)));
  g1(26,29)=1-T353;
  g1(26,34)=(-((1-params(5))*T348*log(y(25))*T1064+y(29)*params(5)*T352*T1064*log(T264*T267/y(3))));
  g1(27,20)=1;
  g1(27,23)=(-(T861*T868));
  g1(27,37)=(-(T868*T1102));
  g1(28,21)=1;
  g1(28,23)=(-(T861*T875));
  g1(28,37)=(-(T875*(T1102-exp(y(37)))));
  g1(29,22)=1;
  g1(29,23)=(-((y(23)*T370*T364*(-T861)-T370)/(y(23)*y(23))/exp(y(37))));
  g1(29,37)=(-((exp(y(37))*T370*T364*(-T1102)/y(23)-exp(y(37))*T370/y(23))/(exp(y(37))*exp(y(37)))));
