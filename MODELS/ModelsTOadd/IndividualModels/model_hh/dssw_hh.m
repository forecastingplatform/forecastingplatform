...
M_.endo_names = char(M_.endo_names, 'dlnIf');
M_.endo_names_tex = char(M_.endo_names_tex, 'dlnIf');
M_.endo_names_long = char(M_.endo_names_long, 'dlnIf');
M_.endo_names = char(M_.endo_names, 'dlnIo');
M_.endo_names_tex = char(M_.endo_names_tex, 'dlnIo');
M_.endo_names_long = char(M_.endo_names_long, 'dlnIo');
M_.endo_names = char(M_.endo_names, 'dlnDin');
M_.endo_names_tex = char(M_.endo_names_tex, 'dlnDin');
M_.endo_names_long = char(M_.endo_names_long, 'dlnDin');
M_.endo_names = char(M_.endo_names, 'dlnPo');
M_.endo_names_tex = char(M_.endo_names_tex, 'dlnPo');
M_.endo_names_long = char(M_.endo_names_long, 'dlnPo');
M_.endo_names = char(M_.endo_names, 'Spreadi');
M_.endo_names_tex = char(M_.endo_names_tex, 'Spreadi');
M_.endo_names_long = char(M_.endo_names_long, 'Spreadi');
...
options_.varobs(3)  = {'dlnIf'};
options_.varobs(4)  = {'lnL'};
options_.varobs(5)  = {'dlnw'};
options_.varobs(6)  = {'dlnP'};
options_.varobs(7)  = {'FedFunds'};
options_.varobs(8)  = {'dlnIo'};
options_.varobs(9)  = {'dlnDin'};
options_.varobs(10)  = {'dlnPo'};
options_.varobs(11)  = {'Spreadi'};
...
erase_compiled_function('dssw_hh_static');
erase_compiled_function('dssw_hh_dynamic');
M_.orig_eq_nbr = 63;
M_.eq_nbr = 63;
M_.ramsey_eq_nbr = 0;
...
save('dssw_hh_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('dssw_hh_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('dssw_hh_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('dssw_hh_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('dssw_hh_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('dssw_hh_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('dssw_hh_results.mat', 'oo_recursive_', '-append');
end
