function [residual, g1, g2, g3] = dssw_static(y, x, params)
%
...
T389 = (y(1)*beta__/T25-beta__*y(1)/T25)/(y(1)*y(1));
T416 = getPowerDeriv(T25*y(3),params(11),1);
T422 = (T76-y(3)*T25*T416)/(T76*T76)/T83;
T423 = getPowerDeriv(T84,T66,1);
T429 = getPowerDeriv(T84,T97,1);
T441 = getPowerDeriv(T83*T76*T107,T110,1);
T444 = getPowerDeriv(T116,(-params(2)),1);
T452 = getPowerDeriv(y(3),params(6),1);
T457 = (T212-y(3)*T452)/(T212*T212)/T215;
T481 = getPowerDeriv(T252,1-params(15),1);
T540 = getPowerDeriv(y(15)/y(6),params(4),1);
T548 = getPowerDeriv(y(6)/y(15),1-params(4),1);
T668 = (-(beta__*y(1)*T25))/(T25*T25)/y(1);
T687 = (-(y(3)*T25*y(3)*T416))/(T76*T76)/T83;
T796 = (exp(y(27))*(-exp(y(27)))-exp(y(27))*(-(1+exp(y(27)))))/(exp(y(27))*exp(y(27)));
  g1(1,1)=y(2)*T389/y(3);
  g1(1,2)=T27/y(3);
  g1(1,3)=(-(T27*y(2)))/(y(3)*y(3));
  g1(1,23)=y(2)*T668/y(3);
  g1(2,1)=1;
  ...
  g1(4,3)=(-(y(7)*exp(y(23)*T66)*beta__*params(10)*T422*T423));
  g1(4,6)=(-(T70*exp(y(25))*getPowerDeriv(y(6),T66,1)));
  g1(4,7)=1-T89;
  g1(4,9)=(-(T68*getPowerDeriv(y(9),1+params(9),1)));
  g1(4,23)=(-(y(7)*(exp(y(23)*T66)*beta__*params(10)*T423*T687+T86*T66*exp(y(23)*T66))));
  g1(4,25)=(-(T68*T70));
  g1(5,1)=(-(y(9)*T94));
  g1(5,3)=(-(y(8)*T101*beta__*params(10)*T422*T429));
  g1(5,6)=(-(y(9)*y(1)*getPowerDeriv(y(6),(1+params(2))/params(2),1)));
  g1(5,8)=1-T102;
  g1(5,9)=(-(y(1)*T94));
  g1(5,23)=(-(y(8)*(T101*beta__*params(10)*T429*T687+T99*T97*T101)));
  g1(6,3)=(-(params(10)*T83*(T107*T25*T416+T76*(-(y(6)/T25))/(y(3)*y(3)))*T441*T444));
  g1(6,5)=(-(T444*(1-params(10))*getPowerDeriv(y(5),T110,1)));
  g1(6,6)=1-T444*params(10)*T441*T83*T76*1/T25/y(3);
  g1(6,23)=(-(T444*params(10)*T441*T83*(T107*T25*y(3)*T416+T76*(-(T25*y(6)))/(T25*T25)/y(3))));
  ...
  g1(8,1)=(-(y(13)*T132*params(7)*T147*exp(y(26))*T389));
  g1(8,13)=(-(exp(y(26))*(T135-T132*params(7)*T131)+T132*params(7)*T27*exp(y(26))*T147));
  g1(8,23)=(-(y(13)*exp(y(26))*((-(params(7)/2*T131*2*T132))-(T132*params(7)*T131+T131*params(7)*T131))+y(13)*(T131*params(7)*T27*exp(y(26))*T147+T132*params(7)*(T147*exp(y(26))*T668+T27*exp(y(26))*T131*2*T131))));
  ...
  g1(15,1)=(-(y(17)*y(21)));
  g1(15,3)=(-(y(19)*beta__*params(5)*T457*getPowerDeriv(T216,(1+exp(y(27)))/exp(y(27)),1)));
  g1(15,17)=(-(y(1)*y(21)));
  g1(15,19)=1-T219;
  g1(15,21)=(-(y(1)*y(17)));
  g1(15,27)=(-(y(19)*beta__*params(5)*T218*(exp(y(27))*exp(y(27))-exp(y(27))*(1+exp(y(27))))/(exp(y(27))*exp(y(27)))*log(T216)));
  g1(16,1)=(-y(21));
  g1(16,3)=(-(y(20)*beta__*params(5)*T457*getPowerDeriv(T216,1/exp(y(27)),1)));
  g1(16,20)=1-T226;
  g1(16,21)=(-y(1));
  g1(16,27)=(-(y(20)*beta__*params(5)*T225*log(T216)*(-exp(y(27)))/(exp(y(27))*exp(y(27)))));
  g1(17,3)=(-(params(5)*T215*(1/y(3)*T452+T212*(-1)/(y(3)*y(3)))*getPowerDeriv(T215*T212*1/y(3),T233,1)));
  ...
  g1(18,3)=(-(T259*T244*T251*1/pic_star__*getPowerDeriv(y(3)/pic_star__,params(13),1)*T481));
  g1(18,21)=(-(T259*T244*T481*T247*((y(21))-y(21))/((y(21))*(y(21)))*getPowerDeriv(y(21)/(y(21)),params(14),1)));
  g1(19,4)=(-1);
  ...
  g1(20,6)=(-(y(22)*y(21)*T273*(-y(15))/(y(6)*y(6))*T540/exp(y(29))));
  g1(20,9)=1;
  g1(20,15)=(-(y(22)*y(21)*T273*T540*1/y(6)/exp(y(29))));
  g1(20,21)=(-(y(22)*T276/exp(y(29))));
  g1(20,22)=(-(y(21)*T276/exp(y(29))));
  g1(20,29)=(-(y(22)*(-(exp(y(29))*y(21)*T276))/(exp(y(29))*exp(y(29)))));
  g1(21,6)=(-(y(22)*y(21)*T283*1/y(15)*T548/exp(y(29))));
  g1(21,10)=1;
  g1(21,15)=(-(y(22)*y(21)*T283*T548*(-y(6))/(y(15)*y(15))/exp(y(29))));
  g1(21,21)=(-(y(22)*T286/exp(y(29))));
  g1(21,22)=(-(y(21)*T286/exp(y(29))));
  g1(21,29)=(-(y(22)*(-(exp(y(29))*y(21)*T286))/(exp(y(29))*exp(y(29)))));
  g1(22,3)=(-(y(22)*params(5)*(y(3)*T215*T452-T212*T215)/(y(3)*y(3))*getPowerDeriv(T212*T215/y(3),T292,1)));
  g1(22,18)=(-((1-params(5))*getPowerDeriv(y(18),T292,1)));
  g1(22,22)=1-T298;
  g1(22,27)=(-((1-params(5))*T293*log(y(18))*T796+y(22)*params(5)*T297*T796*log(T212*T215/y(3))));
