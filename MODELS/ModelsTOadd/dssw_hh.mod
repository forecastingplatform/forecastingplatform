...
estimation(mode_compute=0,datafile=data,plot_priors=0,mode_file=dssw_hh_mode,mode_check,nodiagnostic,mh_replic=125000,mh_nblocks=4,mh_jscale=0.25,mh_drop=0.2,bayesian_irf,irf=40) dlnY, dlnC, dlnIf, lnL, dlnw, dlnP, FedFunds, dlnIo, dlnDin, dlnPo, Spreadi;
