...
fpi_q_obs=100*z;
io_q_obs=(100*z)/100;
dlndin_obs=(100*(z+log(pic))+D_adj)/100;
po_q_obs=(100*log(pic)+Q_o_adj)/100;
...
function f=mu_invgammainf(shape)

% calcualtes mean of inverse gamma distribution with v=2 (infinite
% variance) for a given shape
