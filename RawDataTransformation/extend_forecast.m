function A=extend_forecast(DataInfos,SPFDATA)
...
if transformation~=3
    ...
    B1 = format_variables(cell2mat(filename(1,:)), cell2mat(VintLabel(1,:)), quarterly(1,:),obsformat, vintformat, posobservation, posrelease,transformation);
