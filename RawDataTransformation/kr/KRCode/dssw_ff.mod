...
//estimation(mode_compute=0,datafile=data,mode_file=dssw_ff_mode,plot_priors=0,nodiagnostic,mh_replic=1,mh_nblocks=4,load_mh_file,mh_jscale=0.25,mh_drop=0.2,irf=40) dlnY, dlnC, dlnI, dlnw, lnL, dlnP, FedFunds, dlnDn, Spread;
