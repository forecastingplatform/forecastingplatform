...
F2=0.1; 
f_k_di= @(x)solve_k_di(x,r_k,w,R,gamma_star,delta,alpha,lambda_d,delta_o,pic_star,a,beta_i,gamma,m,lambda_w,phi,nu_l,n_p,lambda_l,g_star,beta,h,tau_i,chi,F2,R_e);
% options     = optimset('Display','off');
[x,fval]    = fsolve(f_k_di,[21,8]);
k           = x(1);
d_i         = x(2);
...
function F = solve_k_di(x,r_k,w,R,gamma_star,delta,alpha,lambda_d,delta_o,pic_star,a,beta_i,gamma,m,lambda_w,phi,nu_l,n_p,lambda_l,g_star,beta,h,tau_i,chi,F2,R_e)
