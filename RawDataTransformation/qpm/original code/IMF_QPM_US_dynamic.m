function [residual, g1, g2, g3] = IMF_QPM_US_dynamic(y, x, params, steady_state, it_)
%
...
residual(7)= lhs-rhs;
lhs =y(39);
rhs =x(it_, 6)+params(7)*y(7)+params(8)*y(84)-params(9)*(y(1)-y(2))-params(18)*(0.04*(y(15)+y(23))+0.08*(y(16)+y(22))+0.12*(y(17)+y(21))+0.16*(y(18)+y(20))+0.2*y(19));
residual(8)= lhs-rhs;
lhs =y(54);
rhs =x(it_, 10);
residual(9)= lhs-rhs;
lhs =y(52);
rhs =x(it_, 10)+y(53)-params(17)*y(87);
residual(10)= lhs-rhs;
lhs =y(53);
rhs =y(14)+x(it_, 11);
residual(11)= lhs-rhs;
...
residual(16)= lhs-rhs;
lhs =y(37);
rhs =y(7)*params(11)+(1-params(10))*y(6)+params(10)*y(90)-x(it_, 8);
residual(17)= lhs-rhs;
lhs =y(42);
rhs =x(it_, 4)+params(12)*y(10)+(1-params(12))*(y(39)*params(14)+y(33)+y(89)+params(13)*(y(89)-params(15)));
residual(18)= lhs-rhs;
lhs =y(32);
rhs =y(42)-y(82);
residual(19)= lhs-rhs;
...
if nargout >= 2,
  ...
  g1(18,42)=1;
  g1(18,94)=(-1);
  g1(18,89)=(-((1-params(12))*(1+params(13))));
  g1(19,32)=1;
  g1(19,82)=1;
  g1(19,42)=(-1);
  g1(20,37)=(-0.25);
