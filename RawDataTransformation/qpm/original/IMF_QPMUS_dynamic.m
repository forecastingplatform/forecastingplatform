function [residual, g1, g2, g3] = IMF_QPMUS_dynamic(y, x, params, steady_state, it_)
%
...
residual(17)= lhs-rhs;
lhs =y(42);
rhs =x(it_, 4)+params(12)*y(10)+(1-params(12))*(y(39)*params(14)+y(33)+y(88)+params(13)*(y(88)-params(15)));
residual(18)= lhs-rhs;
lhs =y(32);
rhs =y(42)-y(81);
residual(19)= lhs-rhs;
